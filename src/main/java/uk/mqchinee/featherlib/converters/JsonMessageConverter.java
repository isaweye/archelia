package uk.mqchinee.featherlib.converters;
...
import uk.mqchinee.featherlib.converters.options.JsonMessageOptions;
...
public final class JsonMessageConverter {
    ...
    public JsonMessageConverter(boolean hover, boolean run, boolean suggest, boolean link, boolean translate, boolean iridium) {
        this.hover = hover;
        this.run = run;
