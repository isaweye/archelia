 ...
 * @since 1.0
 */
public abstract class AbstractArcheliaCommand implements CommandExecutor, TabCompleter {

    @Getter
    private final Map<String, AbstractArcheliaSubcommand> subcommands;
    @Getter
     ...
     */
    public AbstractArcheliaCommand(String command, JavaPlugin plugin) {
     ...
     */
    public void subcommand(AbstractArcheliaSubcommand subcommand) {
